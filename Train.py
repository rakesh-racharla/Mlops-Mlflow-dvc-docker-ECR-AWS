...
if __name__ == "__main__":
    ...
    mlflow.set_experiment(experiment_name="mlops_exp_2") #set eexp should be after set_tracking
    with mlflow.start_run():
        ...
        mlflow.onnx.log_model(onx, "model", registered_model_name="WineModel")
        '''
